...
const Login = ({ onClose, onSignUp, onLogin }) => {
  ...
  return (
    <div className="overlay" onClick={onClose}>
      <form className="form" onClick={(e) => e.stopPropagation()} onSubmit={handleLogin}>
        ...
        <p className="p">Don't have an account? <span className="span" onClick={onSignUp}>Sign Up</span></p>
      </form>
    </div>
  );
};
